...
#
# Generated by export_simulation on Mon Jan 13 09:52:54 +0800 2025
#
################################################################################
...
switch to the './vio_dac_vc_dds.sh' script.

./vio_dac_vc_dds.sh -reset_run
...
./vio_dac_vc_dds.sh -noclean_files

For more information on the script, please type './vio_dac_vc_dds.sh -help'.
